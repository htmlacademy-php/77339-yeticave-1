...
/** @var array $errors */
/** @var array $lotData */
$class = (isset($errors)) ? "form--invalid" : "";
?>
...
<form class="form form--add-lot container <?= $class; ?>" action="../add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__container-two">
        ...
        <div class="form__item <?= $classname; ?>"> <!-- form__item--invalid -->
            ...
            <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" value="<?= htmlspecialchars($lotData['lot-name'] ?? ''); ?>">
            <?php
            if ($classname): ?>
