...
<form class="form form--add-lot container <?= $classnameForm; ?>"
      action="../add.php"
      method="post"
    ...
    <div class="form__container-two">
        ...
        <div class="form__item <?= $classname; ?>"> <!-- form__item--invalid -->
            ...
            <input id="lot-name"
                   ...
                   value="<?= screening($lotData['lot-name'] ?? ''); ?>">
            <?php
            if ($classname) : ?>
    ...
    <div class="form__item form__item--wide <?= $classname; ?>">
        ...
        <textarea id="description" name="description" placeholder="Напишите описание лота"><?= screening(
                $lotData['message'] ?? ''
            ); ?></textarea>
        <?php
        if ($classname) : ?>
    ...
    <div class="form__container-three">
        ...
        <div class="form__item form__item--small <?= $classname; ?>">
            ...
            <input id="lot-rate"
                   ...
                   name="lot-rate"
                   placeholder="0"
                   value="<?= screening($lotData['lot-rate'] ?? ''); ?>">
            <?php
            if ($classname) : ?>
        ...
        <div class="form__item form__item--small <?= $classname; ?>">
            ...
            <input id="lot-step"
                   ...
                   name="lot-step"
                   placeholder="0"
                   value="<?= screening($lotData['lot-step'] ?? ''); ?>">
            <?php
            if ($classname) : ?>
        ...
        <div class="form__item <?= $classname; ?>">
            ...
            <input class="form__input-date"
                   id="lot-date" type="text"
                   name="lot-date"
                   placeholder="Введите дату в формате ГГГГ-ММ-ДД"
                   value="<?= screening($lotData['lot-date'] ?? ''); ?>">
            <?php
            if ($classname) : ?>
