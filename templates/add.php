...
/** @var array $errors */
/** @var array $lotData */
$form = (isset($errors)) ? "form--invalid" : "";
?>
...
<form class="form form--add-lot container <?= $form; ?>" action="../add.php" method="post" enctype="multipart/form-data">
    ...
    <div class="form__container-two">
        <?php
        $class = isset($errors['lot-designation']) ? "form__item--invalid" : ""; ?>
        <div class="form__item <?= $class; ?>"> <!-- form__item--invalid -->
            <label for="lot-name">Наименование <sup>*</sup></label>
            <input id="lot-name" type="text" name="lot-name" placeholder="Введите наименование лота" value="<?= htmlspecialchars($lotData['lot-designation'] ?? ''); ?>">
            <?php
            if ($class): ?>
    ...
    <div class="form__container-three">
        ...
        <div class="form__item form__item--small <?= $class; ?>">
            ...
            <input id="lot-rate" type="text" name="lot-rate" placeholder="0" value="<?= htmlspecialchars($lotData['lot-rate'] ?? ''); ?>">
            <?php if ($class): ?>
        ...
        <div class="form__item form__item--small <?= $class; ?>">
            ...
            <input id="lot-step" type="text" name="lot-step" placeholder="0" value="<?= htmlspecialchars($lotData['lot-step'] ?? ''); ?>">
            <?php if ($class): ?>
        ...
        <div class="form__item <?= $class; ?>">
            ...
            <input class="form__input-date" id="lot-date" type="text" name="lot-date" placeholder="Введите дату в формате ГГГГ-ММ-ДД" value="<?= htmlspecialchars($lotData['lot-date'] ?? ''); ?>">
            <?php if ($class): ?>
